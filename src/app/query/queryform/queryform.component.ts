...
import { FormBuilder, FormGroup, Validators, FormControl, AbstractControl, ValidatorFn, AsyncValidatorFn, ValidationErrors } from '@angular/forms';
...
export class QueryformComponent implements OnInit {
  ...
  constructor(private pageService: PagesService, public modalController: ModalController, private fb: FormBuilder) { }
  ...
  ngOnInit() {
    ...
    console.log("tagsData",this.data,this.tagsData);
    ...
    modal.onDidDismiss().then((submitData) => {
      ...
      if(submitData.role == 'submit') {
        if(submitData.data.length != 0) {
          console.log("tagdData",this.tagsData);
